...
contract RedeemTest is BaseTest {
    ...
    uint256 public constant redeemableLIBRA = 10e6 * 1e18;
    ...
    function setUp() public {
        ...
        LIBRA.setRedemptionReceiver(address(receiver));
        ...
        LIBRA.setMerkleClaim(address(claim));
    }
    ...
    function testClaimAirdrop() public {
        ...
        uint256 preBalance = LIBRA.balanceOf(user);
        ...
        uint256 postBalance = LIBRA.balanceOf(user);
